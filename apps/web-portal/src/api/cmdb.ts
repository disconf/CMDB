import type { Asset,AssetFilters,AssetInput,AssetPage,AssetSummary,CiModel,HistoryEntry,ImportResult } from '@/features/cmdb/types'
...
export const importAssets=(token:string,rows:AssetInput[])=>send<ImportResult>('/api/v1/cmdb/imports',token,'POST',rows)
