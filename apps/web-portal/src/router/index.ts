...
const routes:RouteRecordRaw[]=[
  ...
  {path:'/cmdb',name:'cmdb',component:RouteCanvas,meta:{permission:'cmdb:view'}},{path:'/discovery',name:'discovery',component:RouteCanvas,meta:{permission:'discovery:view'}},{path:'/remote',name:'remote',component:RouteCanvas,meta:{permission:'discovery:view'}},{path:'/topology',name:'topology',component:RouteCanvas,meta:{permission:'topology:view'}},{path:'/monitor',name:'monitor',component:RouteCanvas,meta:{permission:'monitor:view'}},{path:'/jobs',name:'jobs',component:RouteCanvas,meta:{permission:'job:view'}},{path:'/tickets',name:'tickets',component:RouteCanvas,meta:{permission:'ticket:view'}},{path:'/releases',name:'releases',component:RouteCanvas,meta:{permission:'release:view'}},{path:'/toolbox',name:'toolbox',component:RouteCanvas,meta:{permission:'toolbox:use'}},{path:'/aiops',name:'aiops',component:RouteCanvas,meta:{permission:'aiops:view'}},{path:'/system',name:'system',component:RouteCanvas,meta:{permission:'system:manage'}},
